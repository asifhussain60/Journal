...
export default Object.freeze({
  ...
  system: [
    ...
    "- When `constraints.cuisine` is set, ALL returned venues must match that cuisine (not just share a tag). When `constraints.priceTier` is set, honor it as a ceiling. When `constraints.notes` is set, prefer venues that plausibly satisfy it.",
